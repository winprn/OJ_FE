  ...
  <div class="flex-container">
    <div id="problem-main">
      ...
      <Panel :padding="40" shadow>
        <div class="report"><a title="Báo lỗi bài tập này" target="_blank" onclick="event.preventDefault();window.open('https://m.me/anotherk.da', '_blank');" rel="noreferrer nofollow noopener"><i class="ivu-icon ivu-icon-md-bug"></i> {{$t('m.Report')}}</a></div>
